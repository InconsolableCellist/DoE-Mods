...
{
    /// <summary>
    /// Who else in this room is running Descent. Built from Photon player custom
    ...
    /// prefix changed to <c>dd.</c> so the two mods never read each other's identity.
    /// </summary>
    public class ModRoster
    {
        public const string KeyVersion = "dd.ver";
        public const string KeySha = "dd.sha";
        public const string KeyCaps = "dd.caps";
