...
- **Junk of every tier, tonics and armor bundles are picked up by walking over them**
  (`JunkAutoPickup`, `JunkAutoPickupMeters` 0.6; tonics since 0.9.16, armor since 0.9.17 behind
  `AutoPickupArmor`). Weapons are still a hand grab. A weapon or armor that does not fit tosses
